...
sub _body_parser {
    ...
    unless (defined $self->{_body_parser}) {
        require Acore::WAF::Request::BodyParser;
        $self->{_body_parser} = Acore::WAF::Request::BodyParser->new( $self->env );
    }
    $self->{_body_parser};
}
...
sub new_response {
    my $self = shift;
    require Acore::WAF::Response;
    Acore::WAF::Response->new(@_);
}
...
sub content {
    ...
    if ( @args ) {
        Carp::croak "The HTTP::Request method 'content' is unsupported when used as a writer, use Acore::WAF::RequestBuilder";
    } else {
...
Acore::WAF::Request - Portable HTTP request object from PSGI env hash

=head1 SYNOPSIS

  use Acore::WAF::Request;
  ...
  my $res = $req->new_response(200); # new Acore::WAF::Response

=head1 DESCRIPTION

L<Acore::WAF::Request> provides a consistent API for request objects across
...
users). Writing your web application directly using Acore::WAF::Request is
...
handle Cookies and file uploads in your own way: Acore::WAF::Request gives
...
=head2 new
    ...
    Acore::WAF::Request->new( $psgi_env );
...
L<Acore::WAF::Request::Upload> object, or an arrayref of
L<Acore::WAF::Request::Upload> objects.
...
Creates a new L<Acore::WAF::Response> by default. Handy to remove
dependency on L<Acore::WAF::Response> in your code for easy subclassing and
...
L<Acore::WAF::Response> L<HTTP::Request>, L<Catalyst::Request>
