...
Acore::WAF::Response - Portable HTTP Response object for PSGI response

=head1 SYNOPSIS

  use Acore::WAF::Response;

  sub psgi_handler {
      my $env = shift;

      my $res = Acore::WAF::Response->new(200);
...
Acore::WAF::Response allows you a way to create PSGI response array ref through a simple API.
...
=item new
  ...
  $res = Acore::WAF::Response->new;
  $res = Acore::WAF::Response->new($status);
  $res = Acore::WAF::Response->new($status, $headers);
  $res = Acore::WAF::Response->new($status, $headers, $body);

Creates a new Acore::WAF::Response object.
